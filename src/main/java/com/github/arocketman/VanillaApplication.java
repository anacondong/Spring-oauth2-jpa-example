...
public class VanillaApplication {
	...
	// POSTMAN >> Basic Auth >>> user:root,Password:q
	// get Access_token from response
	
	// POST: http://localhost:8080/oauth/token?grant_type=password&username=user&password=user
	// GET: http://localhost:8080/private?access_token=9cf10b54-e193-4141-bcc8-7590dd450b31
